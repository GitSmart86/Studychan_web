...
class Junct_Img_Feedback(models.Model):

    owner = models.ForeignKey(Feedback,
    ...
    def upload_media(self, instance):
        newFile = 'user/{0}/img_feedback/{1}'.format(
    ...
    def save(self, *args, **kwargs):
        ...
        self.name = fileName
        super(Junct_Img_Feedback, self).save(*args, **kwargs)
